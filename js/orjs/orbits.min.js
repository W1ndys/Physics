(function() {
    ...
    // Orbits模块，用于初始化系统并设置地球质量
    (function() {
        Orbits = function(opts) {
            earth = opts.settings.earth;  // 获取地球的设置
            Orbits.setEarthMass(earth.m);  // 设置地球质量
            Orbits.UI = UI(opts.ui);  // 初始化UI模块
            Orbits.Renderer = Renderer(opts.renderer);  // 初始化Renderer模块
            Orbits.Physics = Physics(opts.physics);  // 初始化Physics模块
        ...
        UI = function(opts) {
            ...
            $(earthMass).slider({
                slide: function(event, ui) {
                    ...
                    Orbits.setEarthMass(mass);  // 更新地球质量
                },
